...
public class Warrior { // 정의부, 실행은 Main에서 할 예정임
	...
	// 외부에서 값을 함부로 고칠 수 없도록 public 대신 private로 고친다.
	// public : 모든 영역에서 수정/조회 가능, private : 자기자신만 수정/조회 가능
	...
	// 나머지는 hp 20, strangth 3, lv 1, money 0
	...
	// 체력이 2 깎이고 돈을 10씩 획득합니다.
	// 사냥 결과 체력이 X가 되었고, 소지금은 Y입니다 라고 출력합니다.
	...
	public void hunt() {
		hp -= 2;
		money += 10;
		System.out.println("사냥 결과 체력이 " + hp + "이(가) 되었고, 소지금은 " + money + "입니다.");
	}
}
