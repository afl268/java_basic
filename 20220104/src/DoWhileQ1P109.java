...
public class DoWhileQ1P109 {
	...
	public static void main(String[] args) {
		...
		int order;
		order = scan.nextInt(); // 먼저 주문금액을 받음
		
		do {
			System.out.println("주문금액은 " + order + "원 입니다.");
			System.out.println("배달을 완료했습니다.");
			System.out.println("다음 배달금액을 입력해주세요.");
			order = scan.nextInt(); // do 문으로 반복되는 주문금액문 1번 이상 더 받음
		}
	 while (order >= 15000);
		System.out.println("금액이 모자라 배달 서비스가 종료되었습니다."); // 15000 미만이라 종료
	}
}